package mvcutils.generators {
    import flash.system.Capabilities;

    import mvcutils.storage.LocalStorage;

    //TAKEN from http://snipplr.com/view/45247/as3-globally-unique-identifier-guid/
    public class GUID extends Object {
        private static const COUNTER_ID:String = 'guid_counter';
        ...
        public function postConstruct():void {
            _counter = storage.load(COUNTER_ID, 0);
        }
